...
class Sync extends Backup
{
    ...
    {
        return $this->getLogPath() . '/' . $this->getClientName() . '-upload-daily.log';
    }
    ...
    {
        return $this->getCronTimerDef($this->getInterval()) . ' www-data /usr/bin/php ' . $this->getCronPath('sync') . ' >> ' . $this->getLogFilePath();
    }
}
